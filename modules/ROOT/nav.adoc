...
** xref:5.0@EPO::stories_eEvaluation.adoc[eEvaluation]
** xref:5.0@EPO::stories_eAwarding.adoc[eAwarding]
** xref:5.0@EPO::stories_eQualification.adoc[eQualification]
** xref:5.0@EPO::stories_eRequest.adoc[eRequest]
