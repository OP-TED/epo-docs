...
image::{imagesdir}modules\ROOT\images\uml2owl\P7F1.png[UML visual notation for classes and attributes]
...
specifications. Note that no class methods are ever employed as this document as
the transformations aim at data structures only.

=== *Datatypes and enumerations:* 

image::{imagesdir}modules\ROOT\images\uml2owl\P7F2.png[UML visual notation for datatypes and enumerations]
...
image::{imagesdir}modules\ROOT\images\uml2owl\P7F3.png[UML visual notation for association, generalisation, and dependency]
...
image::{imagesdir}modules\ROOT\images\uml2owl\P8F4.png[Graffoo visual notation for classes, instances and datatypes]
...
image::{imagesdir}modules\ROOT\images\uml2owl\P8F5.png[Graffoo visual notation for classes, instances and datatypes]
