...
image::{imagesdir}modules\ROOT\images\uml2owl\P10F6.png[Visual representation of a class in UML (on the left) and OWL (on the right)]
...
image::{imagesdir}modules\ROOT\images\uml2owl\P11F7.png[Visual representation of an abstract class in UML (on the left) and OWL (on the right)]
...
image::{imagesdir}modules\ROOT\images\uml2owl\P12F8.png[Figure 8: Visual representation of class attributes in UML (on the left) and OWL properties (on the right)]
...
image::{imagesdir}modules\ROOT\images\uml2owl\P15F9.png[Figure 8: Figure 9: Visual representation of class attributes with multiplicity in UML (on the left) and OWL class specialising an anonymous restriction of properties (on the right)]
