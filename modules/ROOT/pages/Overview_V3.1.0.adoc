...
:docdate: June 2023
== Latest Production Release 3.1.0: 16.12.2022
...
The xref:release-notes.adoc[3.1.0 Release Notes] can be found xref:release-notes.adoc[here].

'''
== *Technical Files*

link:https://github.com/OP-TED/ePO/tree/v3.1.0[The 3.1.0 technical build files] can be downloaded from GitHub link:https://github.com/OP-TED/ePO/tree/v3.1.0[here]
