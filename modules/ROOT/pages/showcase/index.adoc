...
=== Querying RDF Data 
Querying eProcurement data in RDF format using the SPARQL query language. Click xref:/showcase/sc_queries.adoc[here] to read more. (queries pages Achillies writing)
