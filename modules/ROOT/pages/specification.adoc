= Specification of the process and methodology to develop the eProcurement ontology with initial draft of the eProcurement Ontology for 3 use cases
...
==== Derive information requirements from the use cases*
