...
The Change Management process is based on generic change and release management processes in ITILv3 and the generic xref:/modules/ROOT/attachments/Methodology-and-tools-for-Structural-Metadata-Management-and-Governance-for-EU-Institutions-and-Member-States_v1.00.pdf[Methodology and tools for Structural Metadata Management and Governance]
