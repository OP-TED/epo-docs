...
image::../images/charter1.png[Figure 1: e-procurement phases]
...
image::{imagesdir}/charter2.png[Figure 2: Stakeholder and User Needs]
...
image::../images/charter3.png[Figure 3: Governance structure]
