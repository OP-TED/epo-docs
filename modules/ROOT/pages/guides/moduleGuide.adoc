...
In order to be able to understand the different parts of this diagram and how to read it please refer to the xref:guides/conceptualModelGuide.adoc#arrows[guide to the ePO Conceptual Model]
...
* https://github.com/SEMICeu/CCCEV[cccev]:
* dcterms:
* foaf:
* org:
* rdf
