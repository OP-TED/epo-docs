...
also  add information about namespaces being the same
explain why it is easier for business people to have the modular approach.
...
This point there is no file containing all imports of the ontology.
...
=== Imports
We need to import classes from other ontologies ... add more explanations here...
...
this is the main diagram. To be able to understand the different parts  of this diagram and how to read it please read... link to conceptual model guide.


image::docUpdateGuideImages/Modules/catalogue.png[]
__ Figure 1: xref:EPO::glossaries.adoc[]. Note the 4.0.1-rc2 version field on the top right.
__
