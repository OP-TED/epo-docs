...
The Change Management process is based on generic change and release management processes in ITILv3 and the generic xref:EPO@new_main::metgovman.adoc[Methodology and tools for Structural Metadata Management and Governance]
