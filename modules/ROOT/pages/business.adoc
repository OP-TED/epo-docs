...
The EU's open data portal website, https://data.europa.eu/, makes EU datasets publicly available on a wide range of topics such as agriculture, health, finance, transport, procurement, and many more. The portal’s intentions are to:
