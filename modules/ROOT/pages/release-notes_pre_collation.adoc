...
modification. Since there has been two release candidates for version 4.0.0, the changes notes are presented as follows:

* v3.1.0 to v4.0.0-rc.1
* v4.0.0-rc.1 to v4.0.0-rc.2
* v4.0.0-rc.2 to v4.0.0
...
|*ePO core*|cpov:ContactPoint|lcon:address -> locn:Address|cv:address -> locn:Address
...
== *eProcurement Ontology v4.0.0-rc.2*
...
||adms:Identifier|skos:notation|epo:hasIdentifierValue
