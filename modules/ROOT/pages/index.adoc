...
[.tile]
.ePO 4.0.0: Latest Production Release
****
The eProcurement Ontology v4.0.0 was released on the 24 November 2023 furthering work on the eFulfilment and eContract modules, amongst other updates.

xref:4.0@EPO::index.adoc[Click here to read the version 4.0.0 details]
...
.ePO Past Releases
****
Information on past releases, versions 1.0.0 through to 3.1.0, of the eProcurement Ontology can be found via the link below. The information includes a brief description of each release. A full description of each release can be found following the links on the Past Releases page.
