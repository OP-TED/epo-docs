...
The ePO conceptualises, formally encodes, and provides structured data about public procurement in both human and machine-readable formats. The ePO is modelled in alignment with EU Directives and Regulations and is a formal standard.
