...
xref:nicole_refactoring@EPO::Overview_V3.1.0.adoc[Click here to read the version 3.1.0 details]
...
xref:nicole_refactoring@EPO::past_releases.adoc[Information on past releases can be found here.]
****
