...
xref:v4.0.0-rc.1:Overview_V4.0.0-rc.1.adoc[Click here to read the version 4.0.0.-rc.1 Overview]
...
xref:v4.0.0-rc.1:release-notes.adoc[Click here to read the 4.0.0-rc.1 Detailed Release Notes]
