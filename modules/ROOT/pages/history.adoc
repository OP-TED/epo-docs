...
image:../images/epo_roadmap August 2023.png[]
[cols="1,2,2"]
|===
|Date|Version|Notes
...
|ePO versions 4.2.0-rc.1 and 4.2.0
|eSubmission module in v4.2.0-rc.1 and eInvoicing module in v4.2.0

|July 2024 and September 2024
|ePO versions 4.3.0-rc.1 and 4.3.0
|Contracts Registry in v4.3.0-rc.1 and eEvaluation in v4.3.0
...
|ePO versions 4.5.0-rc.1 and 4.5.0
|eRequest module in v4.5.0-rc.1 and ePayment module in v4.5.0
|===
