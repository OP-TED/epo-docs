...
diagram (figure q1h). There are 2 ways to access the country: The first is the locn:adminUnitL1 attribute of locn:Address,
...
__ Figure q1h: Connection from org:Organization to at-voc:country via the Location diagram  __
