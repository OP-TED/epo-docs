...
that is usually, connected to the internet. URLs (web addresses) are the most common URIs.

* Decimals are numbers that consists of a whole and a fractional part, while integers represent whole numbers.
