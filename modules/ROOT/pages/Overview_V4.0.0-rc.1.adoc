...
== 4.0.0 candidate release 1: 19.07.2023
...
The xref:release-notes.adoc[4.0.0-rc.1 Release Notes (detailed)] can be found xref:release-notes.adoc[here].

'''
== *Technical Files*

link:https://github.com/OP-TED/ePO/tree/v4.0.0-rc.1[The 4.0.0-rc.1 technical build files] can be downloaded from GitHub link:https://github.com/OP-TED/ePO/tree/v4.0.0-rc.1[here]
